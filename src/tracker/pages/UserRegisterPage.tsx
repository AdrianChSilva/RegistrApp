  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2 mb-4">
        ...
        <InputText id="name" aria-describedby="name-help" className="max-w-xs" />
      </div>
      <div className="flex flex-col gap-2 mb-4">
      ...
      <label htmlFor="role">Role</label>
            <Dropdown value={selectedRole} onChange={(e: DropdownChangeEvent) => setSelectedRole(e.value)} options={countries} optionLabel="name" placeholder="Select a role" 
